...
import org.lims.register.gui.listeners.PrintTestSlipButtonListener;
 ...
 *
 */
public class TestSlipRegisterNumDialog extends JDialog{
	...
	public TestSlipRegisterNumDialog(Frame owner, String title, boolean modal) {
        ...
        JButton addButton=new JButton(resources.getString("register.dialog.button.printTestSlip"));
        addButton.addActionListener(new PrintTestSlipButtonListener(this));        

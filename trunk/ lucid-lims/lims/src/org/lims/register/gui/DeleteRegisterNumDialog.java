...
import org.lims.register.gui.listeners.DeleteRegButtonListener;
 ...
 *
 */
public class DeleteRegisterNumDialog extends JDialog{
	...
	public DeleteRegisterNumDialog(Frame owner, String title, boolean modal) {
        ...
        JButton addButton=new JButton(resources.getString("register.dialog.button.deleteReg"));
        addButton.addActionListener(new DeleteRegButtonListener(this));        

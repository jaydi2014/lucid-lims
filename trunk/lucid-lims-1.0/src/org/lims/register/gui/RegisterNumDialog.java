...
import org.lims.register.gui.listeners.GetRegistrationButtonListener;
 ...
 *
 */
public class RegisterNumDialog extends JDialog{
	...
	public RegisterNumDialog(Frame owner, String title, boolean modal,String actionCmd) {
        ...
        JButton addButton=new JButton(resources.getString("register.dialog.button.dispatchgetRegDetails"));
        addButton.addActionListener(new GetRegistrationButtonListener(this,actionCmd));        
